export const translations = {
  ...
  zh: {
    ...
    // Home Page
    heroTitle: '定制您的手办',
    heroSubtitle: '上传您的照片，我们将把它变成独特的3D手办。优质工艺，精益求精。',
    startCustomizing: '开始定制',

    // How It Works
    howItWorks: '操作流程',
    step1Title: '1. 上传照片',
    step1Desc: '上传任意照片，我们的AI将其转化为3D渲染图',
    step2Title: '2. AI 生成',
    step2Desc: 'AI生成精美的3D风格渲染图供您确认',
    step3Title: '3. 收货',
    step3Desc: '我们将3D打印、手绘涂装并发货到您手中',
    ...
    // CTA
    ctaTitle: '准备好定制您的手办了吗？',
    ctaSubtitle: '今天就开始您的手办定制之旅',
    getStarted: '立即开始',
    ...
    craft: '工艺介绍',
    craftList: [
      { title: '3D打印', desc: '高精度 SLA/DLP 打印技术' },
      { title: '手工涂装', desc: '专业技师手工绘制' },
      { title: '品质检验', desc: '多阶段品质检查' },
      { title: '安全包装', desc: '防震包装确保运输安全' }
    ],
    process: '制作流程',
    processList: [
      { title: 'AI生成', desc: '将照片转化为3D渲染图' },
      { title: '3D建模', desc: '创建精确数字模型' },
      { title: '3D打印', desc: '使用高品质树脂打印' },
      { title: '手工涂装', desc: '精心手绘每一个细节' },
      { title: '品质检验', desc: '确保完美品质' },
      { title: '发货配送', desc: '安全送达您手中' }
    ],
    faq: '常见问题',
    faqList: [
      { q: '需要多长时间？', a: '通常2-3周，包含生产与配送' },
      { q: '需要上传什么照片？', a: '高分辨率、光线充足的照片效果最佳。正面照片效果最好。' },
      { q: '有哪些尺寸可选？', a: '我们提供6cm、8cm、10cm和15cm四种尺寸' },
      { q: '支持国际配送吗？', a: '是的，我们支持全球配送并提供物流追踪' }
    ],
    ...
    uploadFormat: 'PNG、JPG，最大10MB',
    bgFilterTitle: '智能背景过滤',
    bgFilterDesc: '自动去除图片背景，提升生成效果',
    generateBtn: '生成3D预览',
    generatingTitle: '正在生成预览',
    generatingDesc: 'AI正在将您的照片转化为3D风格渲染图...',
    chooseOptions: '选择您的选项',
    selectProduct: '合计：',
    continueBtn: '继续',
    backBtn: '返回',
