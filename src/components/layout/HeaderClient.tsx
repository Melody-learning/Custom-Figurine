      ...
      <div className="container mx-auto flex h-16 items-center justify-between px-4">
        ...
        <nav className="flex items-center gap-4">
          ...
          {user?.hasWelcomeCoupon && (
            ...
            >
              <div className="absolute inset-0 bg-[linear-gradient(115deg,transparent_40%,rgba(255,255,255,0.95)_50%,transparent_60%)] dark:bg-[linear-gradient(115deg,transparent_40%,rgba(255,255,255,0.45)_50%,transparent_60%)] -translate-x-full animate-[shimmer_4s_infinite]" />
