          ...
          <div className="glass-panel p-8 sm:p-10 rounded-3xl shadow-2xl shadow-black/5 flex flex-col space-y-8 animate-slide-up-fade" style={{ animationDelay: '0.1s' }}>
            ...
            <div className="space-y-4">
              ...
              <form action={loginWithGoogle}>
                <button 
                  type="submit"
                  className="w-full relative flex items-center justify-center gap-3 px-6 py-3.5 rounded-xl border border-[var(--border-subtle)] bg-[var(--surface-sunken)] hover:bg-[var(--surface-raised)] transition-all duration-300 group"
                >
                  ...
                  <div className="absolute inset-0 rounded-xl ring-2 ring-[var(--brand-primary)]/0 group-hover:ring-[var(--brand-primary)]/20 transition-all duration-300" />
                </button>
              </form>
              ...
              <form action={loginWithEmail} className="space-y-4">
                <div className="space-y-2">
                  ...
                  <div className="relative group">
                    ...
                    <input
                      ...
                      required
                      className="block w-full pl-11 pr-4 py-3.5 rounded-xl border border-[var(--border-subtle)] bg-[var(--surface-sunken)] text-[var(--text-primary)] placeholder-[var(--text-tertiary)] focus:ring-2 focus:ring-[var(--brand-primary)]/30 focus:border-[var(--brand-primary)] transition-all outline-none"
                    />
                  </div>
                </div>
                ...
                <button
                  type="submit"
                  className="w-full flex items-center justify-center gap-2 py-3.5 px-4 rounded-xl bg-[var(--brand-primary)] text-white hover:bg-[var(--brand-primary)]/90 font-semibold shadow-lg shadow-[var(--brand-primary)]/20 hover:shadow-[var(--brand-primary)]/40 transition-all duration-300 hover:-translate-y-0.5"
                >
                  Send Magic Link
